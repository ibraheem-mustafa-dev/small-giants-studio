  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="mt-8 space-y-6 text-lg text-text-secondary">
                ...
                <p>
                  ...
                  (so you can handle them when they do).
                </p>
                <p>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-primary-50 p-8">
                <Image
                  src="/images/story-bfg.svg"
                  alt="Illustration of a small figure supported by a Big Friendly Giant, looking at a connected horizon"
                  fill
      ...
      <section className="bg-primary-50 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="relative aspect-square max-w-md mx-auto overflow-hidden rounded-2xl border-4 border-white shadow-xl lg:max-w-none">
              <Image
                src="/images/ibraheem-headshot.png"
                alt="Ibraheem Mustafa at work"
                fill
                className="object-cover"
              />
            </div>
            <div>
              ...
              <div className="mt-8 space-y-6 text-lg text-text-secondary">
                <p>
                  ...
                  victim of analysis paralysis. That&apos;s actually why the
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {values.map((value, index) => (
              <div
                key={value.title}
                className={`rounded-xl border border-border bg-background p-6 transition-transform hover:-translate-y-1 ${index % 2 === 0 ? 'lg:mt-4' : 'lg:mb-4'}`}
              >
                <div className="mb-4 h-1 w-12 bg-accent-500 rounded-full" />
