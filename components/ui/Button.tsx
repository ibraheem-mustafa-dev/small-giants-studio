...
const variants = {
  primary:
    "bg-accent-700 text-white hover:bg-accent-800 focus:ring-accent-700 dark:focus:ring-accent-400 shadow-sm hover:shadow-accent-500/25",
  secondary:
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses =
      "inline-flex items-center justify-center font-semibold rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 active:shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
